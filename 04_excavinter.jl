...
# PARAMS = PARAMSDT(CONSTM="DPSSO", TOL=1e-4, THETA=π/6)  
# PARAMS = PARAMSDT(CONSTM="DPconst", TOL=1e-4, THETA=π/6)  
PARAMS = PARAMSDT(CONSTM="Hooke3d")
# PARAMS = PARAMSDT(CONSTM="LSSO", KN=1e10, KS=1e9)
...
postpro(50 * mesh.uvw, mesh.lstp, mesh.coord, mesh.etpl, gps, outdir)
lineplot_excavation(mesh.lstp, mesh.uvw, mesh.coord, Snnodes, outdir)
